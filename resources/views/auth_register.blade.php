...
<div class="container py-5" style="max-width:460px;">
    <div class="text-center mb-3">
        ...
        <div class="text-muted">Create your account</div>
    </div>
    <div class="card auth-card p-4 bg-white">
        <h5 class="mb-3"><i class="fa-solid fa-user-plus me-2"></i>Register</h5>
        <form method="POST" action="{{ route('customer.register') }}">
            ...
            <div class="d-grid gap-2">
                ...
                <a href="{{ route('customer.login.form') }}" class="btn btn-outline-secondary">Already have an account? Login</a>
            </div>
        </form>
    </div>
